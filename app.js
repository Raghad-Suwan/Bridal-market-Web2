...
const appControllersSp = require("./controllers/appControllersSp");
...
const sessionCookieLifeTime = 1000 * 60 * 15; // 15 دقيقة

// تخزين الجلسات للزبائن
const store = new MongoDBStore({
    uri: process.env.DB_URI,
    collection: 'MYsessions'
});

// تخزين الجلسات لمزودي الخدمة
const storeSp = new MongoDBStore({
    uri: process.env.DB_URI,
    collection: 'mysessions'
});

// إعداد الجلسات للزبائن
app.use(
    session({
